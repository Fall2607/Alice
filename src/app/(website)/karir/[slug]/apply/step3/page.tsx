  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-8 duration-500 relative">
      ...
      <div className="space-y-12">
        ...
        <section>
            {/* FIX: HEADER STICKY YANG SEBELUMNYA HILANG */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">
                                ...
                                <div className="lg:col-span-6">
                                    <InputField 
                                        ...
                                        value={edu.ipk || ""} 
                                        onChange={(e)=> updateEducationFormal(edu.id, { ipk: e.target.value })} 
        ...
        <section>
            {/* STICKY HEADER NON FORMAL */}
            <div className="flex justify-between items-center mb-6 sticky top-[140px] md:top-[150px] z-20 bg-white/80 backdrop-blur-md p-4 rounded-2xl border border-slate-200/60 shadow-sm transition-all mt-8 pt-4 border-t border-slate-100">
