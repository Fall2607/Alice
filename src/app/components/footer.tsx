  ...
  return (
    <footer className="bg-primary-dark text-slate-300">
      <div className="container mx-auto px-6 py-12">
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="w-full rounded-l-md px-4 py-2 text-slate-800 focus:outline-none focus:ring-2 focus:ring-secondary"
              />
              <button
                type="submit"
        ...
        <div className="mt-12 border-t border-text-muted pt-8 text-center text-slate-500">
          <p>
